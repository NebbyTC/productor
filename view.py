...
def get_os_window():
	""" Zwraca odpowiednią klasę do dziedziczenia """
...
class Separator(tk.Frame):
	...
	def __init__(self, master):
		super().__init__(master, bg="grey2", relief=tk.RAISED, borderwidth=4, height=1)
...
class About(tk.Toplevel):
	...
	def __init__(self, master):
		...
		wersja = tk.Label(self, text="Wersja 1.0.0")

		produkcja = tk.Text(self, relief=tk.FLAT, wrap=tk.WORD, font="TkDefaultFont", bg="#DDDDDD", height=3)
		produkcja.insert(1.0, "Wyprodukowano przez Pik Software Development S.A. dla M.B. & Spółka")

		licencja = tk.Text(self, relief=tk.FLAT, wrap=tk.WORD, font="TkDefaultFont", bg="#DDDDDD")
		...
		Separator(self).pack(fill=tk.X, padx=10, pady=5)
