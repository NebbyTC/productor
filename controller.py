...
class Controller:
	...
	def load_settings(self):
		...
		self.uwzglednij_dostawe = ustawienia["uwzglednij-dostawe"]
	...
	def create_invoice(self):
		...
		info = {
			...
			"kupione_produkty": self.view.kupione_produkty,
			"uwzglednij_dostawe": self.uwzglednij_dostawe,
			"dostawa": self.dostawa
		}
